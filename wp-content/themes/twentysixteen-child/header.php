		...
		<header id="masthead" class="site-header" role="banner">
			<div class="site-header-main">
				<div class="site-branding">
                	<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="/wp-content/themes/twentysixteen-child/images/mayfield-festival-logo.png" alt="Mayfield Festival" style="height:98px; width:288px;"></a>
